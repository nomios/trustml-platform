  ...
  const resources = [
    {
      ...
      description: "A comprehensive guide covering modern fraud detection techniques, implementation strategies, and best practices for fintech companies.",
    ...
    {
      resourceId: "gameverse-case-study",
      type: "Case Study",
      title: "GameVerse Trust & Safety Case Study",
      description: "Detailed case study of implementing trust & safety systems for a gaming marketplace platform with measurable results.",
      author: "Michael Pezely",
    ...
    {
      resourceId: "marketplace-playbook",
      type: "eBook",
